      ...
      <div class="bg-white rounded-lg shadow-md p-6 mb-6">
        ...
        <form @submit.prevent="modeEdition ? modifierCompetence() : ajouterCompetence()" class="grid grid-cols-1 md:grid-cols-3 gap-4">
          ...
          <div>
            ...
            <input v-model="form.ind1" placeholder="Indicateur 1" class="w-full p-2 border border-gray-300 rounded-lg" required />
          </div>
          <div>
            <label class="block font-medium mb-1">Indicateur 2</label>
            <input v-model="form.ind2" placeholder="Indicateur 2" class="w-full p-2 border border-gray-300 rounded-lg" required />
          </div>
          <div>
            <label class="block font-medium mb-1">Indicateur 3</label>
            <input v-model="form.ind3" placeholder="Indicateur 3" class="w-full p-2 border border-gray-300 rounded-lg" required />
          </div>
